      ...
      <div className="container mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 px-6 relative z-10">
        ...
        <div className="relative lg:ml-auto flex items-center justify-center">
          <div className="relative w-full max-w-lg aspect-square animate-blur-in">
            ...
            <div className="absolute -bottom-8 -left-8 p-4 bg-white rounded-xl shadow-lg animate-slide-up" style={{ animationDelay: '0.2s' }}>
            ...
            <div className="absolute -top-6 -right-6 p-4 bg-white rounded-xl shadow-lg animate-slide-down" style={{ animationDelay: '0.4s' }}>
              <div className="flex items-center gap-3">
                <div className="bg-primary/10 p-3 rounded-lg">
...
const FeaturedProducts = () => {
  const products = [
    ...
    },
    {
      ...
      name: "Leather Wallet",
      imageUrl:
        "https://images.unsplash.com/photo-1585323348432-c9d93c08011c?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80",
      price: "$49.99",
    },
    {
      id: 3,
      ...
      imageUrl:
        "https://images.unsplash.com/photo-1583394842264-10b2e4659d56?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80",
      price: "$99.99",
    },
  ];
  ...
  const newArrivals = [
    {
      ...
      name: "Smart Backpack",
      imageUrl:
        "https://images.unsplash.com/photo-1556020619-7bc4bf2344ca?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80",
      price: "$129.99",
    },
    {
      id: 5,
      ...
      imageUrl:
        "https://images.unsplash.com/photo-1555858254-696695948c78?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80",
      price: "$39.99",
    },
  ];
